...
const MenDetails = () => {
  ...
  useEffect(() => {
    fetch(`https://fakestoreapi.com/products/${menId}`)
      .then((res) => res.json())
        ...
        <Flex p="1rem" bg="white" color="black" flex="3" width="100%">
          <Flex gap="3rem">
            ...
            <Box spaceY="1.2rem" width="45%">
              <Heading>{MensItem.title}</Heading>
              <Text fontWeight="semibold">${MensItem.price}</Text>
              <Text textStyle="xs">{MensItem.description}</Text>
