...
const JeweleryDetails = () => {
  const [JeweleryItem, setJeweleryItem] = useState([]);
  ...
  useEffect(() => {
    fetch(`https://fakestoreapi.com/products/${jewId}`)
      .then((res) => res.json())
      //   .then((json) => console.log(json))
      .then((json) => setJeweleryItem(json))
        ...
        <Flex p="1rem" bg="white" color="black" flex="3" width="100%">
          <Flex gap="3rem">
            ...
            <Box spaceY="1.2rem" width="45%">
              <Heading>{JeweleryItem.title}</Heading>
              <Text fontWeight="semibold">${JeweleryItem.price}</Text>
              <Text textStyle="xs">{JeweleryItem.description}</Text>
          ...
          {related.map((item, index) => (
            ...
            >
              <Image
                ...
                objectFit="contain"
              />
              <Text textStyle="sm" fontWeight="semibold" mt="1rem">
                {item.title}
              </Text>
